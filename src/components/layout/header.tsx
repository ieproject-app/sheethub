    ...
    <header ref={headerRef} className={cn(
        ...
        <nav className={cn(
            ...
            <div className={cn(
                ...
                >
                    {/* Brand Head - Text-based Logo (Reverted) */}
                    <div className="h-full w-14 flex items-center justify-center bg-accent text-primary font-headline font-black text-lg transition-all duration-300 group-hover:w-16 rounded-l-full">
                        SG
                    </div>
