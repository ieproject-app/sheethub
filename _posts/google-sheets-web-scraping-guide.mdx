...
The source owner or editor must authorize the connection the first time. The first step in [web scraping Google Sheets functions](/blog/google-sheets-import-functions-guide) is separating internal spreadsheet imports from public web sources.
...
The [FILTER function for imported Google Sheets data](/blog/filter-function-google-sheets) works directly on the imported range:
