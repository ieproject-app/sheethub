...
{/* CLOUDINARY: D:\Screenshots\sheethub\excel-rounding-functions-round-mround-ceiling-floor-guide\hero.png — worksheet berisi tabel nilai mentah + hasil ROUND, ROUNDUP, ROUNDDOWN, MROUND, CEILING, FLOOR per kolom (semua fungsi family terlihat dalam satu layar) */}
> 📸 Hero: tabel rounding family lengkap dengan hasil
...
{/* CLOUDINARY: D:\Screenshots\sheethub\excel-rounding-functions-round-mround-ceiling-floor-guide\currency-round.png — tabel invoice: unit price 3 desimal x quantity, kolom ROUND dan ROUNDUP dua desimal, baris total yang cocok */}
> 📸 Invoice: ROUND vs ROUNDUP dua desimal + total
...
{/* CLOUDINARY: D:\Screenshots\sheethub\excel-rounding-functions-round-mround-ceiling-floor-guide\time-mround.png — timesheet: kolom jam mentah 7.983 dst, hasil MROUND "0:15" tampil format jam 8:00, plus kolom CEILING dan FLOOR */}
> 📸 Timesheet: MROUND 15 menit + CEILING/FLOOR
...
{/* CLOUDINARY: D:\Screenshots\sheethub\excel-rounding-functions-round-mround-ceiling-floor-guide\negative-round.png — tabel angka negatif (-2.141 dst) dengan hasil ROUNDUP jauh-dari-nol dan ROUNDDOWN mendekati-nol berdampingan */}
> 📸 Angka negatif: ROUNDUP vs ROUNDDOWN
