...
Note: The exact syntax for categorization depends on Google's rollout. Some accounts support an optional third parameter for category hints — test on your own sheet first. <!-- PERLU VERIFIKASI: cek sintaks resmi di dokumentasi Google untuk parameter ke-3 AI() -->
