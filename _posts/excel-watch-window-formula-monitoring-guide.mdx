...
tags: ["excel", "watch-window", "formula-audit", "productivity", "tutorial"]
...
- **Current workbook only.** The window tracks cells inside the active workbook. You cannot watch cells in other open workbooks.
