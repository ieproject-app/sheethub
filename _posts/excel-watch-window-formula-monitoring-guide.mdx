...
- **Not a replacement for trace tools.** To see where a value comes from or what depends on it, use Trace Precedents and Trace Dependents. The [trace precedents and dependents](/blog/excel-trace-precedents-dependents-guide) guide explains the visual arrow approach.
