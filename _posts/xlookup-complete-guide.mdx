...
<DownloadButton id="xlookup-complete-guide" />
...
{/* CLOUDINARY: D:\Screenshots\sheethub\xlookup-complete-guide\hero.png — tabel produk (ID, Name, Price) dengan formula =XLOOKUP("P102",...) di sel samping dan hasilnya terlihat */}
> 📸 Hero: tabel produk + XLOOKUP P102 hasil harga
...
{/* CLOUDINARY: D:\Screenshots\sheethub\xlookup-complete-guide\basic-exact.png — tiga contoh dasar dalam satu sheet: exact match P102, custom "Not found" untuk kode yang tidak ada, dan approximate match bracket pajak */}
> 📸 Basic: exact + "Not found" + bracket pajak
...
{/* CLOUDINARY: D:\Screenshots\sheethub\xlookup-complete-guide\left-lookup.png — sheet dengan kolom lookup di kanan dan hasil dikembalikan dari kolom kiri, menonjolkan arah pencarian kiri yang tidak bisa VLOOKUP */}
> 📸 Left lookup: cari kanan, balikin kiri
...
{/* CLOUDINARY: D:\Screenshots\sheethub\xlookup-complete-guide\multi-column.png — satu formula XLOOKUP dengan return B2:D100, hasil spill 3 sel sebelahnya (name, price, stock) */}
> 📸 Spill 3 kolom dari satu formula
