...
date: "2026-03-08"
description: "Master the step-by-step process of creating a Windows 11 bootable USB using Rufus, including the latest methods to bypass TPM 2.0 and Secure Boot."
...
This guide will walk you through the process step-by-step, from preparation to a ready-to-use USB, including Rufus's advanced features to skip system requirements like the often-troublesome TPM 2.0. Let's get started!
...
<Steps>
  ...
  <Step>
    ...
    *   **Remove requirement for 4GB+ RAM, Secure Boot and TPM 2.0:** **Check this option** if your laptop or PC doesn't meet the minimum requirements for Windows 11. This is a very useful bypass feature.
    *   Other options are optional, such as automatically creating a local account.

    ![Step 3: Customizing Windows options and bypassing TPM 2.0 in Rufus](/images/_posts/rufus/rufus-4.9_3.png "Rufus Screenshot - Step 5")
    *Step 5: Enable the bypass if your PC doesn't support TPM 2.0.*
