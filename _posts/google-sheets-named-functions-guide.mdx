...
For a large array calculation, an [ARRAYFORMULA guide for Google Sheets](/blog/arrayformula-google-sheets-complete-guide) can help you decide whether the logic should spill down a range or be packaged as a reusable function.
