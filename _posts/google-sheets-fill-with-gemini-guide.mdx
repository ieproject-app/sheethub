...
Our [Fill with Gemini Google Sheets and other Gemini features](/blog/gemini-ai-google-sheets-guide) guide covers the other Gemini tools. This article focuses on the context-menu workflow and formula-error fixes.
