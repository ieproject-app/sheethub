...
Price and volume often need different display choices. Prices may use two decimal places, while volume may be easier to scan with thousands separators or scaled units. Apply [Excel custom number formats](/blog/excel-custom-number-formats-guide) to the output cells without changing the underlying values.
