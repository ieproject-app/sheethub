...
When you need a formula for a narrower problem, precise wording matters just as much. The pattern for describing a calculation goal in plain English is covered in [AI prompts for Excel formulas](/blog/ai-excel-formulas-prompt-guide), and it transfers directly to Agent Mode prompts.
