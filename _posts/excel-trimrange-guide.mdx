...
If a source formula already spills to the intended size, trimming may be unnecessary. The [Excel TRIMRANGE function guide](/blog/excel-dynamic-array-functions-guide) explains how this edge-trimming pattern fits with `#` references, while the [Excel spill ranges guide](/blog/excel-spill-ranges-guide) covers spill behavior directly.
