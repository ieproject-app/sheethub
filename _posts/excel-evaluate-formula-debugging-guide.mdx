...
Start with the complete formula, not a nearby input cell. The selected cell is the calculation you are trying to explain. If the cell contains a reference to another sheet, confirm that the reference points to the intended sheet before interpreting the intermediate result.
...
- In manual calculation mode, the displayed result may be stale. Press <Kbd>F9</Kbd> to recalculate the workbook before evaluating the formula, then recalculate again after making a fix.
